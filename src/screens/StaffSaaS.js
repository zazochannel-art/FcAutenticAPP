...
const styles = themedStyles((C) => StyleSheet.create({
  ...
  memberRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 11, borderBottomWidth: 1, borderBottomColor: C.line },
  avatar: { width: 30, height: 30, borderRadius: 15, backgroundColor: C.fill4, alignItems: 'center', justifyContent: 'center' },
  ...
  roleChip: { flex: 1, height: 36, borderRadius: 10, borderWidth: 1, borderColor: C.lineStrong, alignItems: 'center', justifyContent: 'center' },
