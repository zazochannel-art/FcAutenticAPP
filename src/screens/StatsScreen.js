...
const styles = themedStyles((C) => StyleSheet.create({
  ...
  summaryCard: { flex: 1, backgroundColor: C.card, borderRadius: 16, padding: 14, borderWidth: 1, borderColor: C.line, alignItems: "flex-start" },
  ...
  chip: { paddingHorizontal: 14, height: 34, borderRadius: 10, borderWidth: 1, borderColor: C.lineStrong, alignItems: "center", justifyContent: "center" },
  ...
  sortChip: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 12, height: 36, borderRadius: 10, borderWidth: 1, borderColor: C.lineStrong },
  ...
  rowAvatar: { width: 34, height: 34, borderRadius: 17, backgroundColor: C.cyan + "1F", alignItems: "center", justifyContent: "center", marginLeft: 4 },
  ...
  attBar: { height: 5, borderRadius: 3, backgroundColor: C.fill2, marginTop: 6, overflow: "hidden" },
