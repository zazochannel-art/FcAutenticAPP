...
// Ecran principal
// ---------------------------------------------------------------------------
export default function TacticsScreen({ clubId, players = [], selectedClub, currentUser, openNotifications }) {
...
const styles = StyleSheet.create({
  ...
  pitchWrap: { width: "100%", maxWidth: 460, alignSelf: "center", aspectRatio: 0.66, borderRadius: 18, overflow: "hidden", marginBottom: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", position: "relative" },
  ...
  chip: { flexDirection: "row", paddingHorizontal: 12, height: 34, borderRadius: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.1)", alignItems: "center", justifyContent: "center" },
