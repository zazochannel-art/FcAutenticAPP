...
const styles = StyleSheet.create({
  ...
  tile: { flexBasis: 150, flexGrow: 1, backgroundColor: "rgba(15,23,42,0.6)", borderRadius: 14, overflow: "hidden", borderWidth: 1, borderColor: "rgba(255,255,255,0.05)" },
  thumb: { height: 110, backgroundColor: "rgba(2,6,23,0.6)" },
